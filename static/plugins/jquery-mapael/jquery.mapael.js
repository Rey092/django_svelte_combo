...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        drawLink: function (id, xa, ya, xb, yb, elemOptions) {
            ...
            // adminlte(c,d) = adminlte(a,b) (=abDist)
            var abDist = Math.sqrt((xb - xa) * (xb - xa) + (yb - ya) * (yb - ya));

            // Solution for equation adminlte(cd) = sqrt((xd - xc)² + (yd - yc)²)
            // adminlte(c,d)² = (xd - xc)² + (yd - yc)²
            // We assume that adminlte(c,d) = adminlte(a,b)
            // so : (xd - xc)² + (yd - yc)² - adminlte(a,b)² = 0
            // With the factor : (xd - xc)² + (yd - yc)² - (factor*adminlte(a,b))² = 0
            // (xd - xc)² + (acd*xd + bcd - yc)² - (factor*adminlte(a,b))² = 0
            var a = 1 + acd * acd;
